...
@section('content')
    <x-page-header title="Nouveau patient"
                   subtitle="Créez un dossier médical électronique."
                   :breadcrumbs="['Patients' => route('patients.index'), 'Nouveau patient' => null]"/>
    ...
    <form action="{{ route('patients.store') }}" method="POST" novalidate>
        ...
        <div class="mt-5 flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('patients.index') }}" class="k-btn-ghost">Annuler</a>
        </div>
    </form>
@endsection
