...
class IdentifierGenerator
{
     ...
     *
     * @param  string  $prefixKey  clé dans config('keneya.identifiers.prefixes')
     */
    public function next(string $prefixKey, ?int $year = null): string
    {
        $prefix = config("keneya.identifiers.prefixes.{$prefixKey}");
        ...
        $padding = (int) config('keneya.identifiers.padding', 6);
