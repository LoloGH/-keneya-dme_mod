...
class PdfGenerator
{
    ...
    public function prescription(Prescription $prescription): string
    {
        ...
        return $this->render('pdf.prescription', [
    ...
    public function consultationReport(Consultation $consultation): string
    {
        ...
        return $this->render('pdf.consultation', [
    ...
    public function labReport(LabOrder $order): string
    {
        ...
        return $this->render('pdf.lab-report', [
            'order' => $order,
    ...
    public function dischargeSummary(Hospitalization $hospitalization): string
    {
        ...
        return $this->render('pdf.discharge-summary', [
    ...
    public function patientSummary(Patient $patient): string
    {
        ...
        return $this->render('pdf.patient-summary', [
            'patient' => $patient,
    ...
    {
        return $this->render('pdf.certificate', [
            'patient' => $patient,
            'title' => $title,
            'content' => $content,
    ...
    private function render(string $view, array $data): string
    {
        ...
        $data['facility'] = config('keneya.facility');
